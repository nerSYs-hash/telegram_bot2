...
const UPDATES = [
  {
    version: 'V1.11.8d',
    date: '23 апреля 2026',
    title: '🛡 Чистая статистика: дедупликация и фильтры',
    items: [
      { type: 'fix',     tag: 'bot', text: 'Нажатия inline-кнопок меню («📊 Курс», «💰 Баланс» и др.) больше не засчитываются как сообщения пользователя' },
      { type: 'fix',     tag: 'bot', text: 'Убраны ЛС-оповещения администраторам о замороженных пульсах — информация остаётся только в Журнале событий' },
      { type: 'new',     tag: 'bot', text: 'Система дедупликации stat_events_log — каждое событие статистики теперь имеет уникальный ID; повтор игнорируется на уровне БД' },
      { type: 'fix',     tag: 'bot', text: 'Исправлен двойной счёт reactions_given и replies_received — данные за прошлые периоды могут быть завышены' },
    ],
  },
  {
    version: 'V1.11.8',
    date: '21 апреля 2026',
    title: '📊 Статистика: точные данные и исправленный Excel',
    items: [
      { type: 'fix',     tag: 'statistics', text: 'Даты «За вчера» исправлены — период больше не захватывает сегодняшний день ни в чате, ни в файле Excel' },
      { type: 'fix',     tag: 'statistics', text: 'Источник «Добыто» (майнинг) переведён на таблицу user_stats — данные теперь чище и не дублируются' },
      { type: 'fix',     tag: 'statistics', text: 'Excel: разделение по администраторам работает корректно, лишние .00 убраны из числовых ячеек' },
      { type: 'fix',     tag: 'statistics', text: 'Бот не падает при пустых периодах — добавлена защита NULLIF от деления на ноль' },
      { type: 'fix',     tag: 'bot',        text: 'Бот больше не считает реплаи на собственные команды как ответы пользователям' },
    ],
  },
  {
    version: 'V1.11.7',
    date: '16 апреля 2026',
    title: '📈 Переработка системы статистики',
    items: [
      { type: 'improve', tag: 'statistics', text: 'Все данные статистики переведены на таблицу user_stats — единый источник правды вместо устаревшей chat_stats' },
      { type: 'improve', tag: 'statistics', text: 'СДС (средняя длина сообщения) теперь считается динамически — сумма символов / сумма сообщений; точнее, чем хранить среднее' },
      { type: 'fix',     tag: 'statistics', text: 'Устранена гонка данных (race condition) — запись в БД стала атомарной через ON CONFLICT' },
      { type: 'fix',     tag: 'statistics', text: 'Починена почасовая статистика: одна строка на пользователя в час вместо многократного дублирования' },
      { type: 'fix',     tag: 'statistics', text: 'Реакции: засчитывается только факт изменения, а не каждый клик — нельзя «нафармить» индекс активности' },
      { type: 'improve', tag: 'bot',        text: 'Награда «Амбасадор Любви» снижена с 20 до 10 пульсов' },
    ],
  },
  {
    version: 'V1.11.3p',
  ...
  },
  {
    version: 'V1.11.6',
    date: '12 апреля 2026',
    title: '🔕 Уведомления в ЛС и восстановление ББС',
    items: [
      { type: 'fix',     tag: 'bot', text: 'Удалены дублирующиеся ЛС-оповещения администраторам о входах и выходах — теперь только в Журнале событий' },
      { type: 'fix',     tag: 'bot', text: 'Обновлена логика восстановления анкет ББС — заявки восстанавливаются корректно после обрыва' },
    ],
  },
  {
    version: 'V1.11.5',
    date: '8 апреля 2026',
    title: '✍️ Обновлена подпись бота',
    items: [
      { type: 'improve', tag: 'bot', text: 'Подпись в пресс-релизах и гороскопе изменена на «© Сообщество Pulse 2026»' },
    ],
  },
  {
    version: 'V1.11.4',
    date: '2 апреля 2026',
    title: '🔧 Восстановление функций ББС и НьюзON',
    items: [
      { type: 'fix',     tag: 'bot', text: 'Починка восстановления анкет ББС — кнопка «🎁 Компенсация BBS» возвращена в меню восстановления веток' },
      { type: 'fix',     tag: 'bot', text: 'Восстановлены ранее удалённые новости из ветки НьюзON' },
      { type: 'improve', tag: 'bot', text: 'Расширенный FAQ для владельца — добавлены новые разделы по управлению' },
    ],
  },
  {
    version: 'V1.12.9',
  ...
  },
  {
    version: 'V1.12.5',
    date: '17 апреля 2026',
    title: '🧹 Чистка и точная статистика',
    items: [
