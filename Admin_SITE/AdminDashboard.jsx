...
const UPDATES = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'fix',     tag: 'bot', text: 'Нажатия кнопок меню («📊 Курс», «💰 Баланс» и др.) больше не засчитываются как сообщения пользователя' },
      { type: 'fix',     tag: 'bot', text: 'Убраны ЛС-оповещения администраторам о замороженных пульсах — информация только в Журнале событий' },
    ],
  },
  {
    version: 'V1.11.8',
