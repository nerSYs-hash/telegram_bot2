      ...
      case 'statistics':
        return (
          <div className="space-y-4 pb-24">
            ...
            {/* ── Recharts AreaChart ── */}
            <div className={`bg-sff rounded-[2.5rem] p-6 border border-bd shadow-sm transition-all duration-500 ${statsLoading ? 'opacity-40' : 'opacity-100'}`}>
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-[10px] font-black text-lbl uppercase tracking-widest flex items-center">
                  <Activity size={14} className="mr-2 text-cta" /> Пульс активности
                </h3>
                <span className="text-[10px] font-black text-cta bg-[color-mix(in_oklab,var(--cta)_14%,transparent)] px-3 py-1 rounded-full">
            ...
            <div className={`grid grid-cols-2 gap-4 transition-all duration-500 ${statsLoading ? 'opacity-40' : 'opacity-100'}`}>
              {[
                ...
                <div key={i} className="bg-sff p-6 rounded-[2rem] border border-bd shadow-sm active:scale-95 transition-all duration-200"
                  ...
                  <span className="text-[10px] font-black text-lbl uppercase tracking-widest block mb-1">{m.label}</span>
                  <span className="text-3xl font-black text-tx leading-none">{m.val}</span>
                </div>
              ))}
            </div>
