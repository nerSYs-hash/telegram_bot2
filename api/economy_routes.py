...
async def list_categories(authorization: str = Header(default=None)):
    ...
    return get_econ_categories(_db)
...
async def list_settings(
    ...
    return get_econ_settings(_db, category=category, subcategory=subcategory)
...
async def update_setting(
    ...
    try:
        result = set_econ(_db, key, body.value, body.comment.strip(), uid, role)
...
async def toggle_setting(
    ...
    try:
        result = toggle_econ(_db, key, body.comment.strip(), uid, role)
    except ValueError as e:
        raise HTTPException(400, detail=str(e))
...
async def toggle_category(
    ...
    try:
        result = toggle_section(_db, key, body.comment.strip(), uid, role)
    except ValueError as e:
        raise HTTPException(400, detail=str(e))
...
async def get_setting_history(
    ...
    return get_history_for_key(_db, key, limit=limit, offset=offset)
...
async def rollback_setting(
    ...
    try:
        result = rollback_econ(_db, history_id, body.comment.strip(), uid, role)
    except ValueError as e:
        raise HTTPException(400, detail=str(e))
...
async def cancel_pointwise_endpoint(
    ...
    try:
        result = cancel_pointwise(_db, body.tx_id, body.mode, body.comment.strip(), uid, role)
    except ValueError as e:
        raise HTTPException(400, detail=str(e))
...
async def cancel_mass_endpoint(
    ...
    try:
        result = cancel_mass(_db, filter_dict, "log_only", body.comment.strip(), uid, role)
...
async def list_cancellations(
    ...
    return get_cancellations(_db, limit=limit, offset=offset)
...
async def get_metrics(authorization: str = Header(default=None)):
    ...
    return get_economy_metrics(_db)
