...
# -*- coding: utf-8 -*-
"""
Описание: Пакет BBS (Dating Engine) — реэкспортирует все публичные символы
для обратной совместимости со старым кодом, который делал:
    from handlers.bbs_handlers import handle_bbs_callback, process_bbs_input, ...
"""
