...
SEED_ECONOMY_SETTINGS = [
    ('mining.per_message',              'mining', 'base',    'За сообщение',               'Базовое начисление за каждое сообщение',        '0.5',  'float', '💎', 0,    100,    10),
    ('mining.per_reaction_given',       'mining', 'base',    'За поставленную реакцию',    'Начисляется автору реакции',                    '0.1',  'float', '💎', 0,    100,    11),
    ('mining.per_reaction_received',    'mining', 'base',    'За полученную реакцию',      'Начисляется автору сообщения',                  '0.1',  'float', '💎', 0,    100,    12),
    ('mining.per_reply',                'mining', 'base',    'За реплай',                  'Начисляется за ответ на сообщение',             '0.3',  'float', '💎', 0,    100,    13),
    ('mining.per_media',                'mining', 'base',    'За медиа',                   'Фото, видео, документы',                        '1.0',  'float', '💎', 0,    100,    14),
    ('mining.per_char',                 'mining', 'base',    'За символ (множитель)',       'Дополнительный бонус за длину сообщения',       '0.001','float', '',   0,    1,      15),
    ('mining.daily_limit',              'mining', 'base',    'Дневной лимит на юзера',     'Максимум 💎 в сутки с одного пользователя',     '500',  'int',   '💎', 0,    100000, 16),
    ('mining.cooldown_seconds',         'mining', 'base',    'Cooldown антиспам',          'Минимальный интервал между начислениями',        '60',   'int',   'сек',0,   3600,   17),
    ...
    ('defib.buff_multiplier_default',   'mining', 'defib',   'Множитель дефибриллятора',   'Бонус к майнингу от дефибриллятора',            '1.5',  'float', 'x',  1,    10,     60),
    ('defib.buff_duration_hours',       'mining', 'defib',   'Длительность буста',         'Часов действия дефибриллятора',                 '12',   'int',   'ч',  1,    168,    61),
