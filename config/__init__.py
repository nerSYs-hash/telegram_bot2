...
BUG_THREAD_BOT = int(os.getenv('BUG_THREAD_BOT', 12195))
BUG_THREAD_SITE = int(os.getenv('BUG_THREAD_SITE', 14235))
DEVELOPER_ID = int(os.getenv('DEVELOPER_ID', 7536752126))
