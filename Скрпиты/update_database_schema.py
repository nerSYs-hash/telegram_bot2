...
def migrate_database(db_path='database/bot_database.db'):
    ...
    try:
        ...
        try:
            ...
            print("  <tg-emoji emoji-id="5314250708482513617">✅</tg-emoji> Добавлена колонка pulses_mined")
        ...
        for column_name, column_type in new_columns:
            try:
                ...
                print(f"  <tg-emoji emoji-id="5314250708482513617">✅</tg-emoji> Добавлена колонка {column_name}")
            except sqlite3.OperationalError as e:
                if "duplicate column name" in str(e):
        ...
        ''')
        print("  <tg-emoji emoji-id="5314250708482513617">✅</tg-emoji> Таблица topics готова")
        ...
        try:
            ...
            print("  <tg-emoji emoji-id="5314250708482513617">✅</tg-emoji> Добавлена колонка message_thread_id")
        except sqlite3.OperationalError as e:
            if "duplicate column name" in str(e):
        ...
        print(f"  <tg-emoji emoji-id="5314250708482513617">✅</tg-emoji> Обновлено {updated_rows} записей")
        
        conn.commit()
        
        print("\n" + "=" * 70)
        print("<tg-emoji emoji-id="5314250708482513617">✅</tg-emoji> МИГРАЦИЯ ЗАВЕРШЕНА УСПЕШНО!")
        print("=" * 70)
        print()
