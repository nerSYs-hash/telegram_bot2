...
def check_admin_detailed(db_path='database/bot_database.db'):
    ...
    try:
        ...
        print(f"\n<tg-emoji emoji-id="5314250708482513617">✅</tg-emoji> Пользователь найден в базе:")
        ...
        if is_admin_or_owner:
            print(f"\n<tg-emoji emoji-id="5314250708482513617">✅</tg-emoji> РЕЗУЛЬТАТ: Пользователь БУДЕТ заблокирован от получения наград")
        else:
            ...
            print(f"  <tg-emoji emoji-id="5314250708482513617">✅</tg-emoji> Флаги установлены: is_admin=1, is_owner=1")
